...
public interface modelTemplateCoordinate {
	

	// Þablon 1 Sabitleri
	public interface Template1{
		
		public interface Gildan_5000_Mens_Tee{
			
			public interface _5000xB000{
				
				public interface Top_Left{
					
					public static final int _5000xB000_X =560;
					public static final int _5000xB000_Y =497;				
				}
		...
		public interface Gildan_5000_Mens_Tee{
			...
			public interface _5000xB000{
				...
				public interface Top_Left{
					...
					public static final int _5000xB000_X =560;
					public static final int _5000xB000_Y =550;				
				}
		...
		public interface Gildan_5000_Mens_Tee{
			...
			public interface _5000xB000{
				...
				public interface Top_Left{
					...
					public static final int _5000xB000_X =560;
					public static final int _5000xB000_Y =625;				
				}
